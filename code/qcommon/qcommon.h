...
enum {	MAX_JOYSTICK_AXIS = 16,
		...
		JOY_AXIS_GYRO_X = 2,
		JOY_AXIS_GYRO_Y = 3,
		JOY_AXIS_GAMEPADLEFT_X = 4,
		JOY_AXIS_GAMEPADLEFT_Y = 5,
		JOY_AXIS_GAMEPADRIGHT_X = 6,
		JOY_AXIS_GAMEPADRIGHT_Y = 7,
		JOY_AXIS_GAMEPADLEFT_TRIGGER = 8,
		JOY_AXIS_GAMEPADRIGHT_TRIGGER = 9,
};
