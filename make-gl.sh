...
USE_RENDERER_DLOPEN=0 USE_INTERNAL_ZLIB=0 USE_INTERNAL_JPEG=1 BUILD_RENDERER_REND2=0 USE_GLES=1 2>&1 && \
cd build/debug-linux-`uname -m` && ./openarena.`uname -m` +set r_fullscreen 0 $* +devmap oacmpdm3
